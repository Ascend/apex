...
with atheris.instrument_imports():
    from apex.optimizers import NpuFusedRMSpropTF


@atheris.instrument_func
def Test_NpuFusedRMSpropTF(input_bytes):
    ...
    decoupled_decay = input_list[random.randint(0, 1)]
    lr_in_momentum = input_list[random.randint(0, 1)]
    ...
    try:
        ...
        NpuFusedRMSpropTF(params, lr, alpha, eps, weight_decay, momentum, centered, decoupled_decay, lr_in_momentum)
    except Exception as e:
        print(e)
        return True
...
if __name__ == "__main__":
    atheris.Setup(sys.argv, Test_NpuFusedRMSpropTF)
    atheris.Fuzz()
