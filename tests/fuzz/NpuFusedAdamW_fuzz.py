...
def Test_NpuFusedAdamW(input_bytes):
    ...
    amsgrad = input_list[random.randint(0, 1)]
    ...
    try:
        ...
        NpuFusedAdamW(params, lr, betas, eps, weight_decay, amsgrad)
    except Exception as e:
        print(e)
        return True

if __name__ == "__main__":
    atheris.Setup(sys.argv, Test_NpuFusedAdamW)
    atheris.Fuzz()
